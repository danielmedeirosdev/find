...
export function UpdatesButton({ className = '' }: Props) {
  ...
  return (
    <>
      <button
        ...
        ref={triggerRef}
        onClick={showUpdates}
        className={`${className} relative inline-flex min-h-10 items-center gap-2 rounded-lg bg-transparent px-3 py-2 text-sm font-semibold text-charcoal-muted transition-[background-color,color,transform] hover:-translate-y-0.5 hover:bg-charcoal-light hover:text-white`}
      ...
      >
        ...
        {hasUnread ? (
          <span className="absolute -right-1 -top-1 flex h-3 w-3" aria-label="Nova atualização disponível">
            ...
            <span className="relative inline-flex h-3 w-3 rounded-full border-2 border-charcoal bg-brass" aria-hidden="true" />
          </span>
        ) : null}
      </button>
        ...
        ? createPortal(
            <div className="fixed inset-0 z-[100] flex justify-end" role="presentation">
              ...
              <section
                ...
                className="updates-drawer relative z-10 flex h-full w-full max-w-2xl flex-col bg-charcoal shadow-[-24px_0_80px_rgba(0,0,0,0.24)]"
              >
                <header className="flex items-start justify-between gap-4 border-b border-charcoal-light p-5 sm:p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <h2 id="updates-dialog-title" className="mt-1 text-xl font-semibold text-white">
                  ...
                  <button
                    type="button"
                    onClick={closeUpdates}
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-charcoal-muted transition-colors hover:bg-charcoal-light hover:text-white"
                    aria-label="Fechar novidades"
                    autoFocus
                  >
