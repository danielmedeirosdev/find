...
import type { Pet, ShopCustomer } from '../../../lib/types'
  ...
  return (
    <div>
      ...
      <p className="text-sm text-charcoal-muted mb-6">
        Cada cliente pode ter vários pets. O telefone é a chave do agendamento online.
      </p>
      ...
      <FieldHint>Observações opcionais podem ser editadas depois no perfil do cliente.</FieldHint>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        {selected && (
          <div className="rounded-lg border border-charcoal-light p-5">
            ...
            <p className="mt-4 text-sm text-charcoal-muted mb-2">Pets</p>
            <div className="space-y-2">
